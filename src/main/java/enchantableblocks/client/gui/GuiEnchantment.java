...
public class GuiEnchantment extends GuiContainer
{
    ...
    {
        this.fontRendererObj.drawString((this.field_147079_H == null ? I18n.format("container.enchant", new Object[0]) : this.field_147079_H) + (field_147075_G.gabeSale < 1.0F? " -" + Math.round((1.0F - field_147075_G.gabeSale) * 100) + "%" : ""), 12, 5, 4210752);
